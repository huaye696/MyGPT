...
for i in range(0, 14):
    for filename in os.listdir(f'../NewsClassification/train/{i}'):
        with open(f"../NewsClassification/train/{i}/{filename}", 'r', encoding='utf-8') as f:
            content = f.read()
            item = [content, i]
...
for i in range(0, 14):
    for filename in os.listdir(f'../NewsClassification/test/{i}'):
        with open(f"../NewsClassification/test/{i}/{filename}", 'r', encoding='utf-8') as f:
            content = f.read()
            item = [content, i]
